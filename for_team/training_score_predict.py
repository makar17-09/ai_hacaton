        ...
        if vr=="1":
            ...
            self.model = keras.Sequential(
                [
                    ...
                    keras.layers.Dense(500, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-5, l2=1e-4)),
                    keras.layers.Dense(700, activation="relu"),
                    keras.layers.Dense(400, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-4, l2=1e-5)),
            ...
            self.model = keras.Sequential(
                [
                    ...
                    keras.layers.Dense(1300, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-4, l2=1e-4)),
                    keras.layers.Dense(1500, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-3, l2=1e-2)),
                    keras.layers.Dense(1200, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-4, l2=1e-4)),
                    keras.layers.Dense(1, activation="sigmoid"),
                ]
            )
            ...
            self.model = keras.Sequential(
                [
                    ...
                    keras.layers.Dense(999, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-5, l2=1e-4)),
                    keras.layers.Dense(888, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-4, l2=1e-5)),
                    keras.layers.Dense(1, activation="sigmoid"),
                ]
            )
            ...
            self.model = keras.Sequential(
                [
                    ...
                    keras.layers.Dense(666, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-5, l2=1e-5)),
                    keras.layers.Dense(1, activation="sigmoid"),
                ]
            )
            ...
            self.model = keras.Sequential(
                [
                    ...
                    keras.layers.Dense(1500, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-4, l2=1e-4)),
                    keras.layers.Dropout(0.2),
                    keras.layers.Dense(999, activation="relu"),
                    keras.layers.Dropout(0.2),
                    keras.layers.Dense(999, activation="relu"),
                    keras.layers.Dropout(0.3),
                    keras.layers.Dense(500, activation="relu", kernel_regularizer=keras.regularizers.l1_l2(l1=1e-4, l2=1e-4)),
                    keras.layers.Dense(1, activation="sigmoid"),
                ]
            )
